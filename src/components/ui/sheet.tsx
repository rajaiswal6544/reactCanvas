...
>(({ className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed inset-y-0 right-0 z-50 h-full w-80 border-l bg-background p-0 shadow-lg outline-none data-[state=closed]:animate-out data-[state=open]:animate-in sm:w-96",
        className,
      )}
      {...props}
    >
